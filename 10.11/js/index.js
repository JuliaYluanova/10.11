...
const display = () => {
  ...
  for (let i = 0; i < fruits.length; i++) {
    ...
    switch (fruitColor) {
      case "фиолетовый":
        itemList.classList.add("fruit_violet"); //fruit прописанное в скобках отвечает за возникновение рамки
        break;
      case "зеленый":
